...
contract BCM is ERC721Enumerable {
    ...
    mapping(uint256 => uint256) private _tokenGroups;
    mapping(uint256 => uint256[]) private _groupToTokenIds;

    event NFTMinted(address indexed to, uint256 indexed tokenId, uint256 group);
    ...
    function getGroupTokenIds(uint256 group)
        external
        view
